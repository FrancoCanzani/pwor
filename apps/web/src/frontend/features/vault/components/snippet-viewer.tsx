...
const snippetHighlight = HighlightStyle.define([
  ...
  { tag: tags.number, color: "var(--foreground)", fontWeight: "700" },
  { tag: tags.bool, color: "var(--foreground)", fontWeight: "700" },
  ...
  { tag: tags.definition(tags.variableName), color: "var(--foreground)", fontWeight: "700" },
  ...
  { tag: tags.typeName, color: "var(--muted-foreground)", fontWeight: "700" },
  { tag: tags.className, color: "var(--foreground)", fontWeight: "700" },
