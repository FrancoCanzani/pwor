...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-xs font-normal whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-1 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      variant: {
        default:
        ...
        new: "bg-blue-50 text-blue-800 hover:bg-blue-100 hover:text-blue-900 active:bg-blue-100 active:text-blue-900 focus-visible:border-blue-300 focus-visible:ring-blue-200/50 aria-expanded:bg-blue-100 aria-expanded:text-blue-900 dark:bg-blue-950 dark:text-blue-200 dark:hover:bg-blue-900 dark:hover:text-blue-100 dark:active:bg-blue-900 dark:active:text-blue-100 dark:focus-visible:border-blue-700 dark:focus-visible:ring-blue-800/40",
        destructive:
      ...
      size: {
        default:
          "h-7 gap-1 px-2.5 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5",
